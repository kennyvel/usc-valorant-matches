...
<head>
    ...
    <meta name="description" content="This is the page used to submit match results to the database. The user will have to fill out the form on the page if they want to submit any matches and the submission has to follow a lot of rules that will come up as errors at the bottom near the submit button if not followed.">
...
<body>
    ...
    <div class="container">
        <h2 class="mb-4">Match Result Submission</h2>

        <form action="add_confirmation.php" method="POST" onsubmit="return validateForm()">
            <!-- League Name -->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="opponent-team" placeholder="Enter opponent team name" name="opponent_team" required>
            </div>

            <!-- Series Score -->
            <div class="form-group">
                <label for="series-score">Series Score:</label>
                <input type="text" class="form-control" id="series-score" placeholder="Enter series score (e.g., 2-1)" name="series_score" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="map-one-score" placeholder="Enter score for map 1, USC score first (e.g., 13-10)" name="map_one_score" required>

                <label for="map-two-score" class="mt-2">Score for Map 2:</label>
                <input type="text" class="form-control" id="map-two-score" placeholder="Enter score for map 2, if played, USC score first (e.g., 13-10)" name="map_two_score">

                <label for="map-three-score" class="mt-2">Score for Map 3:</label>
                <input type="text" class="form-control" id="map-three-score" placeholder="Enter score for map 3, if played, USC score first (e.g., 13-10)" name="map_three_score">
            </div>

            <!-- Agents Played on Each Map -->
            <div class="form-group">
                <label for="opponent-comp-one" class="mt-2">Map 1 Opponent Comp:</label>
                <input type="text" class="form-control" id="opponent-comp-one" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="opponent_comp_one" required>

                <label for="usc-comp-one" class="mt-2">Map 1 USC Comp:</label>
                <input type="text" class="form-control" id="usc-comp-one" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="usc_comp_one" required>

                <label for="opponent-comp-two" class="mt-2">Map 2 Opponent Comp:</label>
                <input type="text" class="form-control" id="opponent-comp-two" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="opponent_comp_two">

                <label for="usc-comp-two" class="mt-2">Map 2 USC Comp:</label>
                <input type="text" class="form-control" id="usc-comp-two" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="usc_comp_two">

                <label for="opponent-comp-three" class="mt-2">Map 3 Opponent Comp:</label>
                <input type="text" class="form-control" id="opponent-comp-three" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="opponent_comp_three">

                <label for="usc-comp-three" class="mt-2">Map 3 USC Comp:</label>
                <input type="text" class="form-control" id="usc-comp-three" placeholder="(e.g., Jett, Breach, Sova, Omen, Killjoy)" name="usc_comp_three">
            </div>

            <div class="form-group">
                <label for="date-played" class="mt-2">Match Date:</label>
                <input type="date" id="date-played" name="match_date" value="<?php echo date('Y-m-d'); ?>" min="2023-08-21" max="<?php echo date('Y-m-d'); ?>" required>
            </div>
    ...
    <script>
        ...
        function validateAgentNames(namesString) 
        {
            ...
            var inputNames = namesString.split(',').map(name => capitalizeFirstLetter(name.trim()));
